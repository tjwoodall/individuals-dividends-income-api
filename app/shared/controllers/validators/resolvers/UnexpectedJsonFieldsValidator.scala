...
object UnexpectedJsonFieldsValidator extends ResolverSupport {
  ...
  object SchemaStructureSource {
    ...
    given stringInstance: SchemaStructureSource[String] = instance(_ => SchemaStructure.Leaf)

    given intInstance: SchemaStructureSource[Int] = instance(_ => SchemaStructure.Leaf)

    given doubleInstance: SchemaStructureSource[Double] = instance(_ => SchemaStructure.Leaf)

    given booleanInstance: SchemaStructureSource[Boolean] = instance(_ => SchemaStructure.Leaf)

    given bigIntInstance: SchemaStructureSource[BigInt] = instance(_ => SchemaStructure.Leaf)

    given bigDecimalInstance: SchemaStructureSource[BigDecimal] = instance(_ => SchemaStructure.Leaf)

    given taxYearInstance: SchemaStructureSource[TaxYear] = instance(_ => SchemaStructure.Leaf)
