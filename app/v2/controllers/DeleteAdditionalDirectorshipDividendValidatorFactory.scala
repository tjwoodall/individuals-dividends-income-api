...
@Singleton
class DeleteAdditionalDirectorshipDividendValidatorFactory {

  def validator(nino: String, taxYear: String, employmentId: String): Validator[DeleteAdditionalDirectorshipDividendRequest] =
