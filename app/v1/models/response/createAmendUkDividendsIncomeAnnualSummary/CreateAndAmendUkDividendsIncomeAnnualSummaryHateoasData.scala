...
object CreateAndAmendUkDividendsIncomeAnnualSummaryHateoasData extends HateoasLinks {
  ...
  implicit object LinksFactory extends HateoasLinksFactory[Unit, CreateAndAmendUkDividendsIncomeAnnualSummaryHateoasData] {
    ...
    override def links(appConfig: AppConfig, data: CreateAndAmendUkDividendsIncomeAnnualSummaryHateoasData): Seq[Link] = {
      import data._
      Seq(
...
case class CreateAndAmendUkDividendsIncomeAnnualSummaryHateoasData(nino: String, taxYear: String) extends HateoasData
