...
trait MockRetrieveUkDividendsAnnualIncomeSummaryRequestParser extends MockFactory {
  ...
  val mockRetrieveUkDividendsAnnualIncomeSummaryRequestParser: RetrieveUkDividendsIncomeAnnualSummaryRequestParser =
    mock[RetrieveUkDividendsIncomeAnnualSummaryRequestParser]
  ...
  object MockRetrieveUkDividendsAnnualIncomeSummaryRequestParser {
    ...
    def parse(data: RetrieveUkDividendsAnnualIncomeSummaryRawData): CallHandler[Either[ErrorWrapper, RetrieveUkDividendsAnnualIncomeSummaryRequest]] =
      (mockRetrieveUkDividendsAnnualIncomeSummaryRequestParser
        .parseRequest(_: RetrieveUkDividendsAnnualIncomeSummaryRawData)(_: String))
        .expects(data, *)
