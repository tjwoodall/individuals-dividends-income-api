...
trait MockDeleteUkDividendsIncomeAnnualSummaryRequestParser extends MockFactory {
  ...
  val mockDeleteUkDividendsIncomeAnnualSummaryRequestParser: DeleteUkDividendsIncomeAnnualSummaryRequestParser =
    mock[DeleteUkDividendsIncomeAnnualSummaryRequestParser]

  object MockDeleteUkDividendsIncomeAnnualSummaryRequestParser {

    def parse(data: DeleteUkDividendsIncomeAnnualSummaryRawData): CallHandler[Either[ErrorWrapper, DeleteUkDividendsIncomeAnnualSummaryRequest]] =
