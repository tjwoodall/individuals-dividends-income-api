...
trait MockRetrieveDividendsService extends TestSuite with MockFactory {

  val mockRetrieveDividendsService: RetrieveDividendsService = mock[RetrieveDividendsService]
