...
trait MockRetrieveUkDividendsIncomeAnnualSummaryValidator extends MockFactory {
  ...
  val mockRetrieveUkDividendsIncomeAnnualSummaryValidator: RetrieveUkDividendsIncomeAnnualSummaryValidator =
    mock[RetrieveUkDividendsIncomeAnnualSummaryValidator]
