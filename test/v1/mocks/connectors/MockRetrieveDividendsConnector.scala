...
trait MockRetrieveDividendsConnector extends MockFactory {

  val mockRetrieveDividendsConnector = mock[RetrieveDividendsConnector]

  object MockRetrieveDividendsConnector {

    def retrieve(requestData: RetrieveDividendsRequest): CallHandler[Future[DownstreamOutcome[RetrieveDividendsResponse]]] =
      (mockRetrieveDividendsConnector
        .retrieve(_: RetrieveDividendsRequest)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
