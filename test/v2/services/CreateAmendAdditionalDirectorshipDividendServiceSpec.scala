...
import v2.mocks.connectors.MockCreateAmendAdditionalDirectorshipDividendConnector
import v2.models.request.createAmendAdditionalDirectorshipDividend._

import scala.concurrent.Future

class CreateAmendAdditionalDirectorshipDividendServiceSpec extends ServiceSpec {
  ...
  "CreateAmendAdditionalDirectorshipDividendService" when {
    "createAmend" should {
  ...
  private trait Test extends MockCreateAmendAdditionalDirectorshipDividendConnector {

    val request: CreateAmendAdditionalDirectorshipDividendRequest = CreateAmendAdditionalDirectorshipDividendRequest(
      nino = nino,
      taxYear = taxYear,
    ...
    val service: CreateAmendAdditionalDirectorshipDividendService = new CreateAmendAdditionalDirectorshipDividendService(
      connector = mockCreateAmendAdditionalDirectorshipDividendConnector
    )
