...
import v2.connectors.DeleteUkDividendsIncomeAnnualSummaryConnector
...
trait MockDeleteUkDividendsIncomeAnnualSummaryConnector extends TestSuite with MockFactory {
  ...
  object MockDeleteUkDividendsIncomeAnnualSummaryConnector {

    def delete(requestData: DeleteUkDividendsIncomeAnnualSummaryRequest): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (mockConnector
