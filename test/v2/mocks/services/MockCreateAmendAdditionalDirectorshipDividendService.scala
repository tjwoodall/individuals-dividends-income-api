...
trait MockCreateAmendAdditionalDirectorshipDividendService extends MockFactory {
  ...
  object MockCreateAmendAdditionalDirectorshipDividendService {
    ...
    def createAmend(requestData: CreateAmendAdditionalDirectorshipDividendRequest): CallHandler[Future[ServiceOutcome[Unit]]] = {
      (
